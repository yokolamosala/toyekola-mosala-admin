...
import { KanbanCard, Comment, ListName, Task } from 'src/app/modules/api/kanban';
import { Member } from 'src/app/modules/api/member';
import { KanbanAppComponent } from '../kanban.app.component';
import { MemberService } from 'src/app/modules/service/member.service';
